...
async function getInputString() {
  ...
  return inputText || (await promises_namespaceObject.readFile(inputFile, 'utf8'))
}
...
async function writeFile(filePath, data) {
  await promises_namespaceObject.mkdir(external_path_.dirname(filePath), { recursive: true })
  await promises_namespaceObject.writeFile(filePath, data)
}
